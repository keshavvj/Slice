...
export function Footer({
    ...
    return (
        <footer className="pb-6 pt-16 lg:pb-8 lg:pt-24 border-t border-white/5 bg-black">
                        ...
                        <ul className="list-none flex flex-wrap -my-1 -mx-3 lg:justify-end">
                            {legalLinks.map((link, i) => (
                                <li key={i} className="my-1 mx-3 shrink-0">
                                    <a
                                        href={link.href}
                                        className="text-sm text-white/40 underline-offset-4 hover:underline hover:text-white/60 transition-colors"
                                    >
                                        {link.label}
                                    </a>
                                </li>
